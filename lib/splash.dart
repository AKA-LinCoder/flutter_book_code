...
import 'package:flutter_book_code/utils/date_utils.dart';
...
class _IndexPageState extends State<SplashPage> {
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ///边框圆角
            ...
            border: Border.all(
              width: 3,
              color: golbalCurrentTheme(context)?.textTheme.headline1?.color??Colors.white,
            )),
        ///显示的文本
      ...
      return Positioned(
        ...
        child: InkWell(
          onTap: () {
            ...
            ///跳转首页
            NavigatorUtils.openPageByFade(context, Container(),isReplace: true);
          },
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border: Border.all(
                  width: 3,
                  color: golbalCurrentTheme(context)?.textTheme.headline1?.color??Colors.black,
                )),
            child: Column(
              mainAxisSize: MainAxisSize.min,
              children: [
  ...
  buildTopText(int value) {
    ...
    if (value < splList.length - 1) {
      ...
      ///如果是最后一页
      ///修改显示的文本为当前的时间
      text1 = EchoDateUtils.getNowDateStr();
      ///当前星期几
      text2 = "${EchoDateUtils.getNowWeekDay()}";
      ///修改容器为矩形
      topWidth = 130;
      topHeight = 80;
      topRadius = 2;
