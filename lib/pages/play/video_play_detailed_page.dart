...
import 'package:flutter_book_code/pages/play/video_play_controller_page.dart';

import 'package:video_player/video_player.dart';

import '../../base/base_life_state.dart';
...
class _VideoPlayDetailedState extends BaseLifeState<VideoPlayDetailed> {
  ...
  void videoPlayerClickFunction() {
    ...
    ///是否初始化完成
    bool initialized = videoPlayerValue.isInitialized;
    ///是否正在播放
