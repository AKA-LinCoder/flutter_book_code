...
import 'package:flutter_book_code/common/user_helper.dart';
import 'package:flutter_book_code/common/webview_page.dart';
...
class UserProtocolRequestPage extends StatefulWidget {
  ...
  const UserProtocolRequestPage({super.key, this.isColseApp = true});
  @override
